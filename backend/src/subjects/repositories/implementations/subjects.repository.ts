...
import { ISubjectsRepository } from '../i.subjects.repository';
...
export class SubjectsRepository extends ISubjectsRepository {
  ...
  public async create(
    ...
    const data: Database['public']['Tables']['subjects']['Insert'] = {
      name,
  ...
  public async update(
    ...
    const data: Database['public']['Tables']['subjects']['Update'] = {
      updated_by: userId,
  ...
  public async delete(subjectId: string, userId: string): Promise<void> {
    const result = await this.databaseService
      .from('subjects')
      .update({
        is_active: false,
  ...
  private mapToEntity(
    data: Database['public']['Tables']['subjects']['Row'],
  ): Subject {
