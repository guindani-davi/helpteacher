        ...
        <header class="navbar bg-base-100 border-b border-base-300 sticky top-0 z-30">
          ...
          <div class="flex-none">
            <div class="dropdown dropdown-end">
              ...
              <ul
                tabindex="0"
                class="menu menu-sm dropdown-content bg-base-100 rounded-box z-50 mt-3 w-52 p-2 shadow border border-base-300"
              >
      ...
      <div class="drawer-side z-40">
        ...
        <aside class="menu bg-base-100 border-r border-base-300 w-64 min-h-full p-4">
          ...
          <ul class="space-y-1">
            ...
            <div class="divider text-xs text-base-content/40 my-2">Curriculum</div>
            <li>
            ...
            <div class="divider text-xs text-base-content/40 my-2">Settings</div>
            <li>
              <a
